...
def test_expire_at_rounding():
    ...
    data = LinkCreate(original_url="http://example.com", expire_at=future_date)
...
def test_expire_at_past_error():
    ...
    with pytest.raises(ValueError):
        LinkCreate(original_url="http://example.com", expire_at=past_date)